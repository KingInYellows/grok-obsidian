...
- Validates `Cf-Access-Jwt-Assertion` signature, issuer, audience, and subject in Cloudflare Access mode. The stored owner is a pseudonym, not the raw identity.
...
- [Later Cloudflare and Grok setup](docs/CLOUDFLARE-GROK-SETUP.md)
- [Security boundary](SECURITY.md)
- [Planning package](outputs/README.md)

No Cloudflare Tunnel, Access application, Grok connector, credential, or live vault access is created by this repository.
